...
const ContestDetails=({contest_id,total_questions,max_score,start_time,end_time})=>{
    ...
    return(
        <div className="w-full h-full z-0 relative">
            <div className="w-full h-full bg-[url(https://d3oknbjxzqnj9i.cloudfront.net/cdn/background-night.webp)] bg-cover bg-center bg-no-repeat  rounded-lg filter -z-10 absolute blur-sm "></div>
