const teamMembers = [
  { 
    name: 'Manpreet', 
    role: 'Backend', 
    image: 'https://cdn.jsdelivr.net/gh/dhs26206/cuddly-goggles@70f2603/Copanda/team-img1.png', 
  ...
  { 
    name: 'Gaurav', 
    role: 'Traitor', 
    image: 'https://cdn.jsdelivr.net/gh/dhs26206/cuddly-goggles@70f2603/Copanda/team-img2.png', 
  ...
  { 
    name:'Ayush', 
    role:'Frontend', 
    image:'https://cdn.jsdelivr.net/gh/dhs26206/cuddly-goggles@70f2603/Copanda/avatar-2.png',
              ...
              <div className="w-full flex flex-col items-center">
                ...
                <div className="flex mt-2 space-x-4">
                  ...
                  <div className="h-10 w-10 flex items-center justify-center rounded-full bg-white">
                    <img
                      className="h-6 w-6 cursor-pointer"
                      src="https://cdn.jsdelivr.net/gh/dhs26206/cuddly-goggles@70f2603/Copanda/githublogov2.png"
                      alt="GitHub"
