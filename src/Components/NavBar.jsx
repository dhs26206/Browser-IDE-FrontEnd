...
const NavBar=()=>{
    ...
    const divStyle = {
        ...
        backgroundImage: 'linear-gradient(90deg, #000000 6%, #000000 28%, #000000 100%)'
      };
      const handlleClick=()=>{
        setClick(prev=>!prev);
    ...
    return(
        <div className="h-full min-h-16 w-screen flex items-center">
            ...
            <div style={divStyle} className="w-screen h-full items-center flex justify-between">
                <img className={`  w-64 h-14 pl-5`} src="https://d3oknbjxzqnj9i.cloudfront.net/cdn/logo.png" alt="" />
                ...
                <div className="h-14  items-center rounded-md hidden sm:hidden md:flex cursor-pointer text-white ]" >
                    <button onClick={handleNavigateLogin} className="flex  bg-[rgba(0,31, 121, 127)] mr-5 gap-1 hover:bg-[#03F7EB]"><span>Log In</span> <span className="w-5 h-6"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#ffffff" d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg></span> </button>
                </div>
                {/* <div>LeaderBoard</div>
                <div>About</div>
                <div>Contact Us</div>
